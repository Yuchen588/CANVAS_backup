...
└── Downstream_Analysis/        # Module 4: Downstream biological, spatial, and clinical analyses
    ...
    │   ├── Cell_Cell_Interaction.txt                  # Cell-cell interaction analysis
    │   ├── Cell_Type_Clinical_Parameters.R            # Associates cell features with clinical parameters
    │   └── GNN_Based_Cell_Network_Triplet_Motif_Analysis.txt  # GNN-based triplet motif and cell network analysis
    │
    ...
    │   ├── Distance_and_Proximity_Density_Generation.txt  # Generates distance and proximity-density features
    │   └── Proximity_Density_Analysis.R               # Analyzes proximity-density relationships
    │
    ├── Figure4/                # CANVAS model performance and molecular/clinical association analyses
